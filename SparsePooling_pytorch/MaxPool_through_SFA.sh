...
python -m SparsePooling_pytorch.downstream_classification --save_dir SparsePooling_MaxPool_through_SFA_end_to_end_supervised --num_epochs 100 --end_to_end_supervised --in_channels 400
...
python -m SparsePooling_pytorch.main --save_dir SparsePooling_MaxPool_through_SFA --num_epochs 10 --dataset_type "moving" --dataset "stl10" --patch_size 25 --tau 0.01 --sequence_length 20 --reload_BP --model_num 99 --model_path ./logs/SparsePooling_MaxPool_through_SFA_end_to_end_supervised
