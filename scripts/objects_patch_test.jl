...
if sparse_part
  set_init_bars!(network.layers[2],hidden_size_sparse,one_over_tau_a = 1e-3, reinit_weights = true)
...
if pool_part
  ...
  set_init_bars!(network.layers[3]; one_over_tau_a = 1/3, activationfunction = lin!)
