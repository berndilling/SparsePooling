...
function update_layer_parameters_sparse!(layer_pre, layer_post::layer_sparse)
	...
	layer_post.v += -layer_post.parameters.learningrate_v*layer_post.p^2
	...
	BLAS.axpy!(layer_post.parameters.learningrate_thr,layer_post.a-layer_post.p,layer_post.t)
