...
if sparse_part
  ...
  save(string(getsavepath(),"SparsePooling/analysis/SFA/sparse_",dataset_sparse,"_",hidden_size,".jld"),
      "network", network, "squared_errors", errors, "ffd", ffd)

  save(string("/root/lcncluster/data102/SparsePooling/sparse_",dataset_sparse,"_",hidden_size,".jld"),
      "network", network, "squared_errors", errors, "ffd", ffd)
  # figure()
...
if pool_part
  network = load(string(getsavepath(),"SparsePooling/analysis/SFA/sparse_",dataset_sparse,"_",hidden_size,".jld"),"network")
  ...
  if generate_hr
    ...
    save(string(getsavepath(),"SparsePooling/analysis/SFA/SC_hidden_rep_jittered_",dataset_pool,"_",hidden_size,".jld"),
      "jitteredpatches", jitteredpatches, "hidden_reps", smallimgs)
    save(string("/root/lcncluster/data102/SparsePooling/SC_hidden_rep_jittered_",dataset_pool,"_",hidden_size,".jld"),
        "jitteredpatches", jitteredpatches, "hidden_reps", smallimgs)

  else
    jitteredpatches = load(string(getsavepath(),"SparsePooling/analysis/SFA/SC_hidden_rep_jittered_",dataset_sparse,"_",hidden_size,".jld"),"jitteredpatches")
    smallimgs = load(string(getsavepath(),"SparsePooling/analysis/SFA/SC_hidden_rep_jittered_",dataset_sparse,"_",hidden_size,".jld"),"hidden_reps")
  end
  ...
  save(string(getsavepath(),"SparsePooling/analysis/SFA/pool_",dataset_pool,"_",hidden_size,".jld"),
      "network", network_2, "squared_errors", errors)
  save(string("/root/lcncluster/data102/SparsePooling/pool_",dataset_pool,"_",hidden_size,".jld"),
      "network", network_2, "squared_errors", errors)
end
